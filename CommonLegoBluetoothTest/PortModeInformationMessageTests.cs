...
namespace CommonLegoBluetoothTest
{
    ...
    {
        [TestMethod]
        [DataRow(new byte[] { 10, 0, 0x44, 1, 2, 0, 78, 97, 109, 101 }, (byte)1, (byte)2, (byte)ModeInformationType.Name, "Name", 0f, 0f, 0f, 0f, 0f, 0f, "", (ushort)0, (byte)0, new byte[0], new byte[0])]
        ...
        [DataRow(new byte[] { 10, 0, 0x44, 5, 6, 4, 83, 121, 109, 98 }, (byte)5, (byte)6, (byte)ModeInformationType.Symbol, "", 0f, 0f, 0f, 0f, 0f, 0f, "Symb", (ushort)0, (byte)0, new byte[0], new byte[0])]
        ...
        [TestMethod]
        [DataRow((byte)0, (byte)1, (byte)2, (byte)ModeInformationType.Name, "Name", 0f, 0f, 0f, 0f, 0f, 0f, "", (ushort)0, (byte)0, new byte[0], new byte[0], new byte[] { 10, 0, 0x44, 1, 2, 0, 78, 97, 109, 101 })]
        ...
        [DataRow((byte)0, (byte)5, (byte)6, (byte)ModeInformationType.Symbol, "", 0f, 0f, 0f, 0f, 0f, 0f, "Symb", (ushort)0, (byte)0, new byte[0], new byte[0], new byte[] { 10, 0, 0x44, 5, 6, 4, 83, 121, 109, 98 })]
